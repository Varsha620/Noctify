  ...
  return (
    <div className="flex justify-between items-center p-4 mt-[-20px]">
      ...
      <div className="relative w-full max-w-md md:w-1/3">
        <input
          className="w-full p-2 pl-8 rounded-md border border-[#6366F1] focus:outline-none focus:ring-2 focus:ring-purple-500 bg-[#EEEEFF] transition-all duration-200 focus:shadow-lg"
          placeholder="Search"
          type="text"
        />
        <span className="absolute left-2 top-3 transition-colors duration-200">
      ...
      <div className="flex items-center space-x-2 md:space-x-4">
        {/* Notification */}
        <div className="p-2 relative cursor-pointer transform transition-all duration-200 hover:scale-110">
          <span className="flex items-center justify-center w-11 h-11 rounded-full bg-[#B5B6ED] text-lg hover:bg-[#9B9BFE] transition-colors duration-200 hover:shadow-lg">
