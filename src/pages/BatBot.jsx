  ...
  return (
    <div className="flex">
      ...
      <div className="flex flex-col w-full min-h-screen bg-[#ffffff] p-4 md:p-6 pb-20 md:pb-6">
          ...
          <div className="w-full lg:w-1/3">
            <div className="p-4 bg-white rounded-xl animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
              <div className="flex items-center justify-between mb-2">
                ...
                <button className="text-sm text-purple-500 transition-colors duration-200 hover:underline">See all</button>
              </div>
              <ul className="mt-4 space-y-4">
                {[
                  ...
                  <li key={index} className="flex items-center justify-between bg-[#EEEEFF] rounded-lg px-3 py-3 transform transition-all duration-200 hover:scale-105 hover:shadow-md animate-slideInRight"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-gray-400 transition-colors duration-200 cursor-pointer hover:text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {/* Cards Grid */}
        <div className="grid h-auto grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4 mt-7">
