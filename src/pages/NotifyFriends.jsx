  ...
  return (
    <div className="flex flex-col w-full min-h-screen bg-white md:flex-row">
      ...
      <div className="flex flex-col w-full p-4 pb-20 md:pb-4">
        <Navbar />
        <h2 className="text-2xl md:text-3xl font-light text-[#424495] mt-6 mb-4 ml-2 animate-fadeInUp">NOTIFY YOUR FRIENDS</h2>
        ...
        <div className="flex flex-col gap-6 lg:flex-row">
          ...
          <div className="flex flex-1 rounded-2xl bg-[#EEEEFF] shadow-lg overflow-hidden min-h-[500px] border-[#6163A8] border-[1px] animate-fadeInUp" style={{ boxShadow: '0px 4px 15px 5px #6163A8' }}>
              ...
              <div className="flex flex-col gap-2 px-1 md:px-2 max-h-96 overflow-y-auto">
                {chats.map((chat, index) => (
                  <div key={index} className="animate-slideInLeft" style={{ animationDelay: `${0.1 * index}s` }}>
                    <ChatCard name={chat.name} icon={chat.icon} lastUpdate={chat.lastUpdate} isActive={chat.isActive} />
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="flex flex-1 flex-col justify-end items-center bg-[#EEEEFF] p-2 md:p-4 relative">
              ...
              {/* Chat Input */}
              <div className="flex items-center w-full max-w-sm px-3 md:px-4 py-2 mt-4 bg-white rounded-full shadow-inner border border-[#6366F1]">
                <input type="text" placeholder="Notify something exciting✨..." className="flex-1 outline-none text-sm text-[#3C3E87] placeholder-[#787bd6b0]" />
                <button className="ml-2 w-8 h-8 bg-[#BDBDFE] rounded-full flex items-center justify-center hover:bg-[#9B9BFE] transition-all duration-200 transform hover:scale-110 active:scale-95">↑</button>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-between gap-4 w-full lg:w-[28%]">
            ...
            <div className="bg-[#EEEEFF] p-4 rounded-2xl shadow-lg animate-fadeInUp" style={{ boxShadow: '0px 4px 15px 5px #6163A8', animationDelay: '0.2s' }}>
              ...
              <ul className="space-y-3 max-h-64 overflow-y-auto">
                {updates.map((update, i) => (
                  <li key={i} className="flex items-center justify-between px-3 md:px-4 py-2 text-xs md:text-sm bg-white rounded-lg shadow-sm animate-slideInRight transform transition-all duration-200 hover:scale-105" style={{ animationDelay: `${0.1 * i}s` }}>
            ...
            <div className="bg-[#EEEEFF] px-4 md:px-5 py-4 rounded-2xl shadow-lg flex flex-col justify-between animate-fadeInUp" style={{ boxShadow: '0px 4px 15px 5px #6163A8', animationDelay: '0.3s' }}>
              ...
              <button className="self-end text-sm px-4 md:px-5 py-2 rounded-xl text-white bg-gradient-to-r from-[#5C3CFF] to-[#E44B88] shadow-md transform transition-all duration-200 hover:scale-105 active:scale-95">
                New +
              </button>
            </div>
          </div>
