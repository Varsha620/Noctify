            ...
            <div className="bg-gradient-to-br from-[#544ECD] to-[#2A2767] text-white rounded-2xl shadow-xl p-4 md:p-6 min-h-[180px] animate-fadeInUp">
                <div className="flex flex-col md:flex-row gap-3 items-center md:items-start">
                    ...
                    <div className="text-center md:text-left">
                        <h3 className="ml-0 md:ml-5 text-xl md:text-2xl font-light">Average spent this Month:</h3>
                        <p className="ml-0 md:ml-5 text-2xl md:text-3xl font-semibold">Rs.5,000</p>
                    </div>
                </div>
            </div>
              ...
              <table className="w-full text-left min-w-[400px]">
                <thead className="text-[#3C3E87] font-medium border-b-2 border-[#3C3E87]">
                  <tr className="text-sm md:text-md">
                    ...
                    <th className="px-2 md:px-4 pb-2">Amount</th>
                ...
                <tbody className="text-[#3C3E87] text-xs md:text-sm">
                  {[
                    ...
                    <tr key={idx} className="h-12 md:h-14 animate-slideInUp hover:bg-white/50 transition-colors duration-200" style={{ animationDelay: `${0.1 * idx}s` }}>
                      <td>
