  ...
  return (
    <div className="flex flex-col w-full min-h-screen bg-[#072D44] md:flex-row">
      ...
      <div className="flex flex-col w-full p-4 pb-20 md:pb-4">
        ...
        <h2 className="text-2xl md:text-3xl font-light text-[#D0D7E1] mt-6 mb-4 ml-2">
          EXPENSE TRACKER
        </h2>
        ...
        <div className="flex flex-col gap-6 lg:flex-row">
          ...
          <div className="flex flex-col flex-1 gap-4">
            {/* Average Spend Card */}
            <div className="bg-gradient-to-br from-[#064469] to-[#5790AB] text-white rounded-2xl shadow-xl p-4 md:p-6 min-h-[180px]">
            ...
            <div className="bg-gradient-to-br from-[#5790AB] to-[#9CCDDB] p-4 md:p-6 rounded-2xl shadow-lg">
              <h3 className="mb-4 text-xl font-semibold text-[#072D44] md:text-2xl">My Pending Bills</h3>
              <div className="space-y-3 overflow-y-auto max-h-60">
                {getPendingBills.length > 0 ? (
                  getPendingBills.map((bill) => (
                    <div key={bill.id} className="flex items-center justify-between p-3 rounded-lg bg-white/60">
                      <div>
                  ...
                  <p className="py-4 text-center text-[#064469]">No pending bills</p>
                )}
              </div>
            </div>
            ...
            <div className="flex flex-col gap-4 md:flex-row">
              <div className="flex flex-col justify-between bg-gradient-to-br from-[#064469] to-[#5790AB] p-4 md:p-6 rounded-2xl shadow-lg flex-1">
                <div>
                ...
                <button 
                  className="mt-4 px-4 py-2 bg-white text-[#064469] rounded-xl hover:bg-gray-100 text-sm w-fit font-medium transition-colors"
              ...
              <div className="flex flex-col justify-between bg-gradient-to-br from-[#9CCDDB] to-[#D0D7E1] flex-1 p-4 md:p-6 shadow-lg rounded-2xl">
                <div>
                  ...
                  <p className="mt-3 mb-5 ml-2 text-base md:text-lg text-[#072D44]">Add a new bill.</p>
                </div>
                <button 
                  className="px-4 py-2 mt-4 text-sm font-medium text-[#072D44] transition-colors bg-[#072D44]/20 rounded-xl hover:bg-[#072D44]/30 w-fit"
                  onClick={() => setAddModalOpen(true)}
                >
                  Add Now →
                </button>
          ...
          {/* Transactions Panel */}
          <div className="flex-1 p-4 rounded-2xl md:p-6 bg-gradient-to-br from-[#064469] to-[#5790AB]">
