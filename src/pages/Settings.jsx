      ...
      <div className="flex flex-col w-full p-4 pb-20 md:pb-4">
        ...
        <div className="max-w-4xl mx-auto w-full space-y-6">
          ...
          <div className="bg-[#EEEEFF] rounded-2xl p-6 shadow-lg animate-fadeInUp" style={{ boxShadow: '-8px 5px 15px #6366F1', animationDelay: '0.1s' }}>
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={item.key} className="flex items-center justify-between p-4 bg-white rounded-xl hover:shadow-md transition-all duration-200">
                  <div>
          ...
          <div className="bg-[#EEEEFF] rounded-2xl p-6 shadow-lg animate-fadeInUp" style={{ boxShadow: '-8px 5px 15px #6366F1', animationDelay: '0.2s' }}>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-white rounded-xl hover:shadow-md transition-all duration-200">
                <div>
              ...
              <div className="p-4 bg-white rounded-xl hover:shadow-md transition-all duration-200">
          ...
          {/* Danger Zone */}
          <div className="bg-red-50 border border-red-200 rounded-2xl p-6 animate-fadeInUp" style={{ animationDelay: '0.3s' }}>
            <h2 className="text-2xl font-semibold text-red-600 mb-4 flex items-center gap-3">
              <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="space-y-4">
              <button className="w-full md:w-auto px-6 py-3 bg-red-600 text-white rounded-xl hover:bg-red-700 transition-all duration-200 transform hover:scale-105">
                Clear All Data
              </button>
              <button className="w-full md:w-auto px-6 py-3 bg-red-600 text-white rounded-xl hover:bg-red-700 transition-all duration-200 transform hover:scale-105 md:ml-4">
                Delete Account
              </button>
            </div>
          </div>
