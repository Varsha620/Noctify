  ...
  return (
    <div className="flex">
      ...
      <div className="flex flex-col w-full min-h-screen bg-[#ffffff] p-4 md:p-6 pb-20 md:pb-6">
        <Navbar />
        <h1 className="text-2xl md:text-3xl font-light text-[#424495] mt-6 mb-4 ml-2 animate-fadeInUp">DASHBOARD</h1>
        ...
        <div className="flex flex-col gap-6 mt-2 lg:flex-row">
          ...
          <div className="flex flex-col w-full gap-6 lg:w-2/3">
            ...
            <div className="bg-[#EEEEFF] p-4 md:p-6 rounded-2xl flex flex-col md:flex-row justify-between items-center min-h-[200px] md:h-90 animate-fadeInUp"
              ...
              {/* Left side */}
              <div className="flex flex-col justify-between text-center md:text-left mb-4 md:mb-0">
                ...
                {/* Chat prompt */}
                <div className="flex flex-col md:flex-row items-center gap-4 mt-4 md:mt-5 ml-0 md:ml-9">
          ...
          <div className="w-full lg:w-1/3">
            <div className="p-4 bg-white rounded-xl animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
              <div className="flex items-center justify-between mb-2">
                ...
                <button className="text-sm text-purple-500 hover:underline transition-colors duration-200">See all</button>
              </div>
              <ul className="mt-4 space-y-4">
                {[
                  'Warden on rounds 🚨',
                  'Aradhana updated food 🍎',
                  'Maggie soon?'
                ].map((notification, index) => (
                  <li key={index} className="flex items-center justify-between bg-[#EEEEFF] rounded-lg px-3 py-3 transform transition-all duration-200 hover:scale-105 hover:shadow-md animate-slideInRight"
                    style={{
                      boxShadow: '-8px 5px 10px #6366F1',
                      animationDelay: `${0.1 * index}s`
                    }}>
                    <span className="text-sm md:text-base">{notification}</span>
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-gray-400 cursor-pointer hover:text-gray-600 transition-colors duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {/* Cards Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mt-7 h-auto">
          <div className="animate-fadeInUp" style={{ animationDelay: '0.3s' }}>
            <Card title="Average spent this Month" value="Rs. 5,000" 
              icon={
                <svg width="50" height="50" viewBox="10 0 100 90" fill="none" xmlns="http://www.w3.org/2000/svg" className="md:w-[70px] md:h-[70px]">
          ...
          <div className="animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
            <Card title="Items Available" value="Tomato +3 more" 
              icon={
                <svg width="50" height="50" viewBox="0 0 75 75" fill="none" xmlns="http://www.w3.org/2000/svg" className="md:w-[65px] md:h-[65px]">
          ...
          <div className="animate-fadeInUp" style={{ animationDelay: '0.5s' }}>
            <Card title="Latest Expiring item" value="Paneer" 
              icon={
                <svg width="40" height="40" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg" className="md:w-[50px] md:h-[50px]">
          ...
          <div className="animate-fadeInUp" style={{ animationDelay: '0.6s' }}>
            <Card title="Notify your friends" value="" 
              icon={
                <svg width="35" height="35" viewBox="0 0 75 75" fill="none" xmlns="http://www.w3.org/2000/svg" className="md:w-[45px] md:h-[45px]">
